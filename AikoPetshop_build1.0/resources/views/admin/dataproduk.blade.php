...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
        <a href="/createproduk" role="button" class="btn btn-success">Tambah Produk</a>
    ...
    <table id="datagrooming" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$produk->link}}</td>
                <td>{{$produk->harga}}</td>
                <td><img src="../storage/{{$produk->photo}}" style="width:110px;height:110px;"></td>
                <td><a href="/editproduk/{{$produk->id}}" role="button" class="btn btn-warning">Edit</a> &nbsp;
                    ...
                    <div class="modal-dialog modal-confirm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center">
                                ...
                                <form action="/deleteproduk/{{$produk->id}}" method="post" style="display: inline;">
                                    @method('DELETE')
                                    @csrf
