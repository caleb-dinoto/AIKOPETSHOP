        ...
        <div class="col-lg-8">
          ...
          @csrf
            ...
            <div class="form-outline mb-4">
              ...
              <input type="text" class="form-control" name="harga" placeholder="100,000" required>
            </div>

            <div class="form-outline mb-4">
              <label class="form-label" for="form3Example4">Link ke Tokopedia</label>
              <input type="text" class="form-control" name="link" placeholder="https://www.tokopedia.com/aiko-pet/makanan-kucing-1st-choice-kitten-2-72kg?extParam=whid%3D10125614" required>
            </div>
